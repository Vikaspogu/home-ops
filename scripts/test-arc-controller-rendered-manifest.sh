...
[[ "$(yq ea -r '.applications."arc-controller".annotations."argocd.argoproj.io/sync-wave"' "${APPLICATIONS}")" == "33" ]] || fail "ARC controller must sync after the KubeVirt and CDI operators"
